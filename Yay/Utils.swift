...
import Foundation
    ...
    struct Color
    {
        static let PrimaryActiveColor = UIColor(red:CGFloat(3/255.0), green:CGFloat(118/255.0), blue:CGFloat(114/255.0), alpha: 1)
        ...
        static let GenderActiveColor = UIColor(red:CGFloat(253/255.0), green:CGFloat(185/255.0), blue:CGFloat(38/255.0), alpha: 1)
